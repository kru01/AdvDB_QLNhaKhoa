...
CREATE OR ALTER PROC USP_THUOC_UPD
    ...
    @GIATIEN INT
AS BEGIN TRAN
    IF NOT EXISTS (SELECT IDTHUOC FROM THUOC WHERE IDTHUOC = @IDTHUOC) BEGIN
...
CREATE OR ALTER PROC USP_THUOC_SEARCH
    ...
    @DONVITINH INT = NULL, -- 0: VIÊN, 1: GÓI, 2: HỘP
    @CHIDINH NVARCHAR(200) = NULL,
...
AS BEGIN TRAN
    ...
    EXEC sp_executesql @SQL,
        N'@IDTHUOC CHAR(7), @TENTHUOC NVARCHAR(100), @DONVITINH INT,
        @CHIDINH NVARCHAR(200), @SOLUONGTONKHO INT, @NGAYHETHAN DATE,
        @GIATIEN INT',
