...
CREATE OR ALTER PROC USP_TOATHUOC_INS
    ...
    @SOLUONG INT = 1
AS BEGIN TRAN
    IF NOT EXISTS (SELECT IDKEHOACH FROM KEHOACHDIEUTRI
    ...
    IF EXISTS (SELECT IDKEHOACH FROM TOATHUOC WHERE IDHOSO = @IDHOSO
...
CREATE OR ALTER PROC USP_TOATHUOC_UPD
    ...
    @SOLUONG INT = 1
AS BEGIN TRAN
    IF NOT EXISTS (SELECT IDKEHOACH FROM TOATHUOC WHERE IDHOSO = @IDHOSO
        AND IDKEHOACH = @IDKEHOACH AND IDTHUOC = @IDTHUOC) BEGIN
